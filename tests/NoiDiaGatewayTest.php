...
//        Debug::dump($re->getBody(),5);die;
        // process return data
        $response = $this->gateway->createResponse('\Omnipay\OnePay\Message\Response', [ 'vpc_TxnResponseCode' => 0 ],
            'purchase');
    ...
    public function testPurchaseFailure()
    {
        ...
        $response = $this->gateway->createResponse('\Omnipay\OnePay\Message\Response',
